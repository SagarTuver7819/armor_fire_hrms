    ...
    return [
        ...
        'holidays' => [
            ...
            'list_columns'=> [
                ...
                ['key' => 'holiday_date', 'label' => 'From Date'],
                ['key' => 'holiday_to_date', 'label' => 'To Date'],
                ['key' => 'is_paid', 'label' => 'Paid'],
            ...
            'fields' => [
                ...
                ['name' => 'holiday_date', 'label' => 'From Date', 'type' => 'date', 'required' => false, 'span' => 1,
                    'help' => 'DD-MM-YYYY · Start date (required for Holiday type)'],
                ['name' => 'holiday_to_date', 'label' => 'To Date', 'type' => 'date', 'required' => false, 'span' => 1,
                    'help' => 'DD-MM-YYYY · End date · Same as From for single day · Range counts every day in between'],

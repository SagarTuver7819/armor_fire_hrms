    ...
    return [
        ...
        'leaves' => [
            ...
            'list_columns'=> [
                ...
                ['key' => 'accrual_type', 'label' => 'Accrual'],
                ['key' => 'max_concurrent_applicants', 'label' => 'Max Concurrent'],
                ['key' => 'is_paid', 'label' => 'Paid'],
            ],
            'fields' => [
                ['name' => 'code', 'label' => 'Code', 'type' => 'text', 'required' => false, 'span' => 1],
                ['name' => 'leave_type', 'label' => 'Leave Type', 'type' => 'text', 'required' => true, 'span' => 2],
                ['name' => 'days_allowed', 'label' => 'Days Allowed (Yearly)', 'type' => 'number', 'required' => false, 'span' => 1, 'default' => 0,
                    'help' => 'PL = 24/year · SL = 24 (2 per month × 12)'],
                ['name' => 'is_paid', 'label' => 'Paid Leave', 'type' => 'select', 'required' => true, 'span' => 1,
                    'options' => ['Yes' => 'Yes', 'No' => 'No'], 'default' => 'Yes'],
                ['name' => 'accrual_type', 'label' => 'Accrual', 'type' => 'select', 'required' => true, 'span' => 1,
                    'options' => ['yearly' => 'Yearly (all at once)', 'monthly' => 'Monthly (credit each month)'], 'default' => 'yearly',
                    'help' => 'Monthly = Days÷12 each month. SL = 2/month'],
                ['name' => 'monthly_carry_forward', 'label' => 'Monthly Carry Forward', 'type' => 'select', 'required' => true, 'span' => 1,
                    'options' => ['1' => 'Yes — unused months carry forward', '0' => 'No — unused wipes each month'], 'default' => '0',
                    'help' => 'PL = Yes · SL = No (wipe unused each month)'],
                ['name' => 'max_concurrent_applicants', 'label' => 'Max Employees at Once', 'type' => 'number', 'required' => false, 'span' => 1, 'default' => 0,
                    'help' => 'PL = 6 (same dates). 0 = unlimited'],
                ['name' => 'allow_encashment', 'label' => 'Year-End Encashment', 'type' => 'select', 'required' => true, 'span' => 1,
                    'options' => ['1' => 'Yes — pay remaining days', '0' => 'No'], 'default' => '0',
                    'help' => 'Remaining days × (salary ÷ 30) at year end'],
                ['name' => 'description', 'label' => 'Description', 'type' => 'textarea', 'required' => false, 'span' => 3],
            ],
        ],
